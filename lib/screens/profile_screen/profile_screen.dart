        ...
        body: SafeArea(
          child: Obx((){
            return controller.isLoading.value
              ...
              : !controller.profileModel.status ? Center(child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Icon(Icons.network_check_sharp,size: 74,color: Colors.grey,),
                  Text(controller.errorMessage!.value,style: TextStyle(color: Colors.grey,)),
                  Text('Check your internet connection, then drag\n down to refresh page',textAlign: TextAlign.center,style: TextStyle(color: Colors.grey,),),
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Column(
                            ...
                            GestureDetector(
                              onTap: (){
                                Get.toNamed(AppRoutes.referralScreen, arguments: controller.data.referralCode);
                              },
                              child: Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
